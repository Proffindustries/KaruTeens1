...
const ClassDetailsModal = ({ classItem, onClose, onUpdate }) => {
    ...
    return (
        <div className="modal-overlay" onClick={onClose}>
            <div
                className="modal class-details-modal"
                        ...
                        <div className="tasks-section">
                            ...
                            >
                                {tasks.length === 0 ? (
                                    ...
                                    >
                                        No tasks for this class yet.
                                    </p>
                                ) : (
                                    tasks.map((task) => (
                                        <div
                                            key={task.id}
                                            className="task-item card shadow-sm"
                                            style={{
                                                display: 'flex',
                                                alignItems: 'center',
                                                padding: '0.75rem',
                        ...
                        <div className="social-section">
                            {!classItem.course_code ? (
                                <p style={{ textAlign: 'center', color: 'var(--text-muted)' }}>
                                    Class needs a Course Code to find classmates.
                                </p>
                            ) : isLoadingClassmates ? (
                                <p
                                    style={{
                                ...
                                >
                                    No classmates found using this course code.
                                </p>
                            ) : (
                                <div
                                    className="classmates-list"
                                    style={{
                                        display: 'flex',
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        These students have <strong>{classItem.course_code}</strong>{' '}
                                        on their public timetable.
                                    </div>
                                    {classmates.map((user) => (
                                        <div
                                            key={user.id}
                                            className="classmate-card card shadow-sm"
                                            style={{
                                                display: 'flex',
                                                alignItems: 'center',
                                                padding: '0.75rem',
