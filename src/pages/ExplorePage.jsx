        ...
        <div className="container explore-page">
            ...
            {trendingLoading && (
                <div className="trending-hashtags-strip card mb-12">
                    <p className="text-muted">Loading trending topics...</p>
                </div>
            )}
            {trendingError && (
                <div className="trending-hashtags-strip card mb-12">
                    <p className="text-muted">Could not load trending topics.</p>
                </div>
            )}
            ...
            <div className="explore-grid">
                {CATEGORIES.map((cat) => (
                    <div key={cat.title} className="explore-section">
                        <h2>{cat.title}</h2>
                        <div className="links-grid">
                            {cat.links.map((link) => (
                                <Link to={link.path} key={link.name} className="explore-card">
                                    <div
