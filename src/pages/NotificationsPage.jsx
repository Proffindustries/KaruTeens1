...
const NotificationsPage = () => {
    ...
    const getIcon = (type) => {
        switch (type) {
            case 'like':
                return <Heart size={20} fill="#ff4757" color="#ff4757" />;
            case 'comment':
                return <MessageCircle size={20} color="#3742fa" />;
            case 'message':
                return <MessageSquare size={20} color="#2ed573" />;
            case 'follow':
                return <UserPlus size={20} color="#2ed573" />;
            default:
                return <Bell size={20} color="#ffa502" />;
        }
    };
