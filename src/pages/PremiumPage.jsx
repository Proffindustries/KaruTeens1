...
const PremiumPage = () => {
    ...
    return (
        <div className="container premium-page" style={{ paddingBottom: '4rem' }}>
                    ...
                    >
                        <div className="premium-pay-form">
                            ...
                            >
                                {loading
                                    ? 'Processing...'
                                    : `Pay Ksh ${selectedPlan === 'weekly' ? 10 : selectedPlan === 'monthly' ? 40 : 200}`}
                            </button>
                        </div>
                    </div>
                </div>
            ...
            {step === 'processing' && (
                <div
                    className="card payment-waiting-card"
                    style={{
                        maxWidth: '400px',
                        margin: '2rem auto',
                        textAlign: 'center',
                ...
                >
                    ...
                    <p>
                        We've sent an STK Push to your phone. Enter your PIN to complete the
                        upgrade.
                    </p>
