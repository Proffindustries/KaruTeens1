...
const MarketplaceItemPage = () => {
    ...
    if (error)
        return (
            <div className="container item-detail-page">Error loading item: {error.message}</div>
        );
    ...
    return (
        <div
            className="container item-detail-page"
            style={{ padding: '2rem 1rem', maxWidth: '1000px' }}
        >
            <Link
                to="/marketplace"
                className="back-link"
            ...
            >
                ...
                <div className="item-info">
                    <div className="card" style={{ padding: '1.5rem', marginBottom: '1.5rem' }}>
                        ...
                        <h1
                            style={{ fontSize: '1.5rem', marginBottom: '0.5rem', color: '#2d3436' }}
                        >
                            {item.title}
                        </h1>
                        <h2 style={{ fontSize: '2rem', color: '#2ed573', margin: '0 0 1rem 0' }}>
                    ...
                    >
                        <Avatar src={item.seller_avatar} name={item.seller_name} size="50px" />
                        <div>
                            <h4 style={{ margin: 0 }}>{item.seller_name}</h4>
                            <p style={{ margin: 0, fontSize: '0.85rem', color: '#636e72' }}>
                                Seller
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <p style={{ fontSize: '0.85rem', color: '#636e72', margin: 0 }}>
                            Meet in a safe, public place like the Student Center or Library. Avoid
                            sending money before seeing the item.
                        </p>
                    </div>
                </div>
            </div>
