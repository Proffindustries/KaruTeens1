                ...
                <div className="settings-content">
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    if (
                                                        confirm(
                                                            `Unblock @${u.username}? They will be able to see your posts and message you again.`,
                                                        )
                                                    ) {
                    ...
                    {activeTab === 'data' && (
                        <div className="settings-section">
                            ...
                            <p className="section-desc">
                                Manage your account data or permanently delete your account.
                            </p>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        >
                                            Download a copy of your posts, messages, and profile
                                            data. This may take a few minutes to prepare.
                                        </p>
                                    </div>
                                </div>
                                <button
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            posts, messages, and data will be permanently removed.
                                        </p>
                                    </div>
                                </div>
                                <button
                            ...
                            {showDeleteModal && (
                                ...
                                >
                                    <div
                                        ...
                                        style={{
                                            backgroundColor: 'var(--bg-color, #1e1e2e)',
                                            padding: '2rem',
                                            borderRadius: '12px',
                                            maxWidth: '400px',
                                            width: '100%',
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <option value="Found another platform">
                        ...
                        <div className="settings-section">
                            ...
                            <div className="form-group" style={{ marginBottom: '2.5rem' }}>
                                ...
                                <div
                                    style={{
                                        display: 'flex',
                                        gap: '1.5rem',
                                        background: 'rgba(var(--card-border), 0.2)',
                                        padding: '1rem',
                                        borderRadius: '8px',
                                        border: '1px solid rgb(var(--card-border))',
                                    }}
                                    ...
                                    {fontSizes.map((sizeObj) => (
                                        ...
                                        >
                                            <input
                                                ...
                                                value={sizeObj.value}
                                                checked={
                                                    appearanceSettings.fontSize === sizeObj.value
                                                }
                                                onChange={() =>
                                                ...
                                                style={{
                                                    width: '18px',
                                                    height: '18px',
                                                    accentColor: 'rgb(var(--primary-color))',
                                                }}
                                            />
                                            <span
                                                style={{
                            ...
                            >
                                <div className="toggle-info" style={{ flex: 1 }}>
                                    ...
                                    >
                                        Decrease spacing between layout elements for a denser view.
                                    </p>
                                </div>
                            ...
                            >
                                <div className="toggle-info" style={{ flex: 1 }}>
                                    ...
                                    >
                                        Display visible borders around content cards and elements.
                                    </p>
                                </div>
                                <label className="switch" style={{ marginLeft: '1rem' }}>
                                    <input
                                        ...
                                        onChange={(e) =>
                                            handleAppearanceChange('showBorders', e.target.checked)
                                        }
                                    />
                                    <span className="slider"></span>
                                </label>
                        ...
                        <div className="settings-section">
                            ...
                            >
                                <div className="toggle-info">
                                    ...
                                    >
                                        Enable or disable all browser push notifications.
                                    </p>
                                </div>
                                <label className="switch" style={{ marginLeft: '1rem' }}>
                                    <input
                            ...
                            <div style={{ display: 'grid', gap: '1rem' }}>
                                {[
                                    ...
                                    },
                                    {
                                        key: 'comments',
                                        label: 'Post comments',
                                        desc: 'Someone comments on your post',
                                    },
                                    {
                                        key: 'mentions',
                                        label: 'Mentions',
                                        desc: 'Someone @mentions you',
                                    },
                                    {
                                        key: 'class_reminders',
                                        label: 'Class reminders',
                                        desc: '15-min alarm before class',
                                    },
                                    {
                                        key: 'template_updates',
                                        label: 'Template updates',
                                        desc: 'A template you forked was updated',
                                    },
                                    {
                                        key: 'ad_promotions',
                                        label: 'Ad promotions',
                                        desc: 'Campus partner offers',
                                    },
                                    {
                                        key: 'email_digest',
                                        label: 'Email digest',
                                    ...
                                    >
                                        ...
                                        <label className="switch" style={{ marginLeft: '1rem' }}>
                                            <input
                                                ...
                                                disabled={
                                                    !pushEnabled && item.key !== 'email_digest'
                                                }
                                            />
                                            <span className="slider"></span>
                                        </label>
