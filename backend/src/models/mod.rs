...
pub use academic::{StudyRoom, Timetable, TimetableClass, RevisionMaterial, RevisionMaterialPurchase, StudyPlaylist, PlaylistItem, RoomMessage, RoomFile, PhysicalRoom, RoomBooking};
